...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'spam' => ['type' => 'boolean', 'length' => null, 'null' => true, 'default' => 'false', 'precision' => null, 'comment' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'body' => 'comment in the other db',
                'spam' => 1,
                'created' => '2021-06-16 01:54:19',
                'modified' => '2021-06-16 01:54:19',
            ],
        ];
        parent::init();
    }
